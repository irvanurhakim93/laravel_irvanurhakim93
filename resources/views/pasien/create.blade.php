                        ...
                        <div class="card-body">
                          <form action=" {{route('pasien.store')}} " method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="basic-default-name" name="namapasien" placeholder="Masukkan nama pasien" required/>
                                </div>
                              </div>
                              <div class="row mb-3">
                              ...
                              <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                  <input
                                    ...
                                    id="basic-default-phone"
                                    name="notelppasien"
                                    placeholder="Masukkan no telp pasien" required/>
                                </div>
                              </div>
                              <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="basic-default-phone">ID Rumah Sakit</label>
                                <div class="col-sm-10">
                                  <input
                                    type="text"
                                    class="form-control"
